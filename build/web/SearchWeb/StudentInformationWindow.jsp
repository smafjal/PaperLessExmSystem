        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form role="form" class="form-horizontal" action="StudentInformation.jsp" method="POST">

                        <div class="form-group">
                            <label class="control-label col-md-2" for="Registration Number">Registration Number:</label>
                            <div class="col-md-8">
                                <input name="regname" type="text" class="form-control" id="registrationNumber" placeholder="Registration Number">
                            </div>
                        </div>
