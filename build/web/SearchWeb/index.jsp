<%-- 
    Document   : index
    Created on : Jan 16, 2015, 5:30:50 AM
    Author     : Sm19
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <li style="width: 500px;height: 80px;font-size: 40px;"><a href="${pageContext.request.contextPath}/SearchWeb/StudentInformationWindow.jsp">Student Information</a></li>
                    <li style="width: 500px;height: 80px;font-size: 40px;"><a href="${pageContext.request.contextPath}/SearchWeb/TeacherInformationWindow.jsp">Teachers Information</a></li>
                </div>
