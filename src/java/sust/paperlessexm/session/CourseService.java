...
public class CourseService implements ICourseService, LocatableService {
     ...
     * greater than or equal to the total number of course instances will simply
     * return an empty set.
     * @param endIndex the end index within the result set
     * (<code>getCourseListSize()</code> = last record), any values greater than
     * or equal to the total number of course instances will cause the full set
     * to be returned.
     * @return a list of Course objects, of size
     ...
     * @return List of Course data objects, empty list in case no results were
     * found.
     */
    ...
    /**
     *
     * Retrieves a list of data object for the specified courseTitle field. To
    ...
    /**
     *
     * Retrieves a list of data object for the specified courseCode field. To
     * use a wildcard search, use a % in the query.
     *
    ...
    /**
     *
     * Retrieves a list of data object for the specified offeringDept field. To
     * use a wildcard search, use a % in the query.
     *
    ...
    /**
     *
     * Retrieves a list of data object for the specified acceptingDept field. To
     * use a wildcard search, use a % in the query.
     *
    ...
    /**
     *
     * Retrieves a list of data object for the specified credit field. To use a
     * wildcard search, use a % in the query.
     *
    ...
    /**
     *
     * Retrieves a list of data object for the specified semester field. To use
     * a wildcard search, use a % in the query.
     *
    ...
    /**
     *
     * Retrieves a list of data object for the specified session field. To use a
     * wildcard search, use a % in the query.
     *
