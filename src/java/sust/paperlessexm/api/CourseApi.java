...
public interface CourseApi {
    ...
    CourseBean addCourse(CourseBean model) throws sust.paperlessexm.exception.GenericBusinessException;
    ...
    CourseBean checkCourse(String courseCode, int session) throws sust.paperlessexm.exception.GenericBusinessException;
