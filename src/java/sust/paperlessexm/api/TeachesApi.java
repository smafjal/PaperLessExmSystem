...
public interface TeachesApi {
    ...
    TeachesBean addTeaches(TeachesBean model) throws sust.paperlessexm.exception.GenericBusinessException;
    ...
    TeachesBean CheckTeaches(int teachersId, int courseId) throws GenericBusinessException;
}
