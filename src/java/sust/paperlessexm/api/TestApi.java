...
public interface TestApi {
    ...
    TestBean addTest(TestBean model) throws sust.paperlessexm.exception.GenericBusinessException;
    ...
    int findTestNo(Integer courseId) throws sust.paperlessexm.exception.GenericBusinessException;
}
