...
public class CourseRegistrationApiImpl implements CourseRegistrationApi{
    ...
    @Override
    public CourseRegistrationBean addCourseRegistration(CourseRegistrationBean model) throws GenericBusinessException {
        ...
        return getCourseRegistration(courseRegistration.getPrimaryKey());
    }
