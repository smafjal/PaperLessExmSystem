...
public class TestRegistrationApiImpl implements TestRegistrationApi {
    ...
    @Override
    public TestRegistrationBean addTestRegistration(TestRegistrationBean model) throws GenericBusinessException {
        ...
        return getTestRegistration(registration.getPrimaryKey());
    }
