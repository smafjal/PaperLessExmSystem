...
public class TestBean {
    ...
    public TestBean(Integer testId, int marks, String testTitle, Date createDate, Date updateDate, Date testTime, int testDuration, String description, int testNo, TeachesBean teachesId, CourseBean courseId) {
        this.testId = testId;
        this.marks = marks;
    ...
    public Test toEntity(TestBean testBean){
        ...
        test.setTestNo(testBean.getTestNo());
        return test;
    }
